...
if __name__ == "__main__":
    ...
    periodList =  session.query(QuarterPeriod).filter(and_(QuarterPeriod.year == 2016, QuarterPeriod.quarter == 1)).order_by(QuarterPeriod.year.asc(), QuarterPeriod.quarter.asc()).all()
